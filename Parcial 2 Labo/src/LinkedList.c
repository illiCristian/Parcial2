...
float ll_countF(LinkedList* this, float (*fn)(void*))
{
    float returnAux=0;
    void* pElement;
    float acumulador=0;
...
//int ll_count(LinkedList* this, void* (*fn)(void*), void* pRetorno)
//{
//    int returnAux=0;
//    void* pElement;
//    int contador=0;
